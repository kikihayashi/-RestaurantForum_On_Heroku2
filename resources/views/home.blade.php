    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="div-restaurant-item">
                <img src="https://raw.githubusercontent.com/kikihayashi/RestaurantForum_Image/main/Food/{{$thisRestaurant->id%10}}.jpg?raw=true"
                    alt="圖片已失效"><br>
                <div style="padding-left:5%; padding-right:5%;">
                    ...
                    <p class="badge badge-dark">
                        <a style="color:white"
                            href="{{route('RestaurantController.category',$thisRestaurant->category_id)}}">
                            {{$thisRestaurant->category_name}}</a>
                    </p>
                    <p style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">
                        {{$thisRestaurant->content}}</p>
                    <!-- 這裡是加到最愛和按讚的模板 -->
...
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
        ...
        @for($i = 1; $i <= $thisTypeRestaurants->lastPage(); $i++)
            ...
            <li class="page-item">
                <a class="page-link" href="{{$thisTypeRestaurants->url($thisTypeRestaurants->lastPage())}}"
                    aria-label="Last">
