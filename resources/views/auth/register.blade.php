      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group row">
              <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('密碼(最少6個字元)') }}</label>

              <div class="col-md-6">
                <input id="password" type="password" pattern=".{6,}" required title="最少6個字元"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="password-confirm" type="password" pattern=".{6,}" required title="最少6個字元"
